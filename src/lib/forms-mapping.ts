  ...
  "animales": {
    ...
    "forms": [
      ...
      },
      {
        ...
        "fields": [
          { "name": "id_propietario", "label": "Propietario", "type": "combobox", "placeholder": "Selecciona un propietario", "required": true, "options": [{ "value": "1", "text": "Maria Lopez" }, { "value": "2", "text": "Juan Martínez" }] }
        ]
      },
      {
    ...
    "forms": [
      {
        ...
        "fields": [
          ...
          { "name": "id", "label": "ID Denuncia", "type": "hidden" },
          { "name": "id_usuario", "label": "ID Usuario", "type": "hidden" },
          { "name": "detalles_extra", "label": "ID Usuario", "type": "hidden" },
